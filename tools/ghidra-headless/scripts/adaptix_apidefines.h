/*
 * Snapshot of AdaptixC2 beacon ApiDefines.h hash table.
 * Used by adaptix_hash_match.py for offline resolution of API hashes
 * observed in decompiled AdaptixC2 beacons.
 *
 * Source:  https://github.com/Adaptix-Framework/AdaptixC2
 *          AdaptixServer/extenders/beacon_agent/src_beacon/beacon/ApiDefines.h
 * License: GPL-3.0 (upstream project)
 *
 * Refresh procedure:
 *   gh api repos/Adaptix-Framework/AdaptixC2/contents/\
 *     AdaptixServer/extenders/beacon_agent/src_beacon/beacon/ApiDefines.h \
 *     --jq '.content' | base64 -d > adaptix_apidefines.h
 */
#pragma once
