"""Centralized requests.Session factory.

All threat-intel modules must use create_session() instead of constructing
sessions directly. Provides:
  - retries on 5xx (3 total, exponential backoff)
  - 429 Retry-After auto-wait (capped at 300s)
  - HTTP/HTTPS/SOCKS5 proxy injection from configvars.proxy
"""
